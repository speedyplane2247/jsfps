...
Simple game
*/
var gunSpeed = [0.5, 10, 0.9, 0.01, 1, 0.7]; // Sniper, Machine, Pistol RPSecond
var pos = [ 0,0, 100 ];
var ai1 = [ 10,10, 100 ]
var ai2 = [ 20,20, 100 ]
var ai3 = [ 21, 55, 100]
...
console.log("To shoot, type shoot(gun,time). Guns are listed below. Time is in S.")
console.log("Guns: Sniper, Pistol, Machine, Rocket, Shotgun, and Rifle.")
...
if (gun == "Rocket") {
    var timeShoot = time * gunSpeed[3]
    console.log(timeShoot + " rounds were shot.")
    tellServerMoved("shot",gun,timeShoot,GameVersion)
    }
    if (gun == "Shotgun") {
        var timeShoot = time * gunSpeed[4]
        console.log(timeShoot + " rounds were shot.")
        tellServerMoved("shot",gun,timeShoot,GameVersion)
        }
        if (gun == "Rifle") {
            var timeShoot = time * gunSpeed[5]
            console.log(timeShoot + " rounds were shot.")
            tellServerMoved("shot",gun,timeShoot,GameVersion)
            }
if (gun == "Machine") {
...
if (pos[0] == ai5[0] && pos[1] == ai5[1]) {
    ...
    if (gunX2 == "Rocket") {
        ai5[2] = ai5[2] - weaponDamage[3] * timeShoot
        tellServerMoved("damage",gunX2,"ai5",ai5[2])
    }
    if (gunX2 == "Shotgun") {
